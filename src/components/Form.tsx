        ...
        return (
            <section className="container pt-3">
                <form action="" className="form-inline d-flex justify-content-center">
                    ...
                    <input type="text" className="form-control mb-2 mr-sm-2" id="inlineFormInputCity2" placeholder="City"/>
                    <label htmlFor="inlineFormInputCountry2" className="sr-only">Country</label>
                    <input type="text" className="form-control mb-2 mr-sm-2" id="inlineFormInputCountry2" placeholder="Country"/>
